...
Mercedes Benz stellt für Kunden und Entwickler eine Plattform ([/developers](https://developer.mercedes-benz.com/)) zur Verfügung, die es erlaubt Servives und Apps in eigenen Produkten zu verwenden.
...
Sie erhalten eine textbasierte Antwort, die etwas lesbarer formatiert wir folgt aussieht:
...
> __Aufgabe:__ Geben Sie den API-Endpunkt, den Längen- (9.2944224) und Breitengrad (48.7378333) für Esslingen zusammen mit dem API-key in die Adresszeile ihres Browsers ein.  
(_Sie können die Koordinaten mit [google maps](https://www.google.com/maps/place/48°44'16.2"N+9°17'47.8"E/@48.7378333,9.2944224,17) überprüfen._)   
`https://api.mercedes-benz.com/dealer/v1/dealers?latitude=48.7378333&longitude=9.2944224&apikey=<insert_your_api_key_here>`
> * Was ist passiert?

### Filtern der Händler nach Attributen

Es besteht die Möglichkeit Händlern nach Eigenschaften zu filtern. Hierzu dient der Paramater `fields`. Um nur die `dealerID`, die Anschrift (`adress` und `city`) und die Emailadresse (`email`) von Händlern anzufragen muss der `fields` Parameter wie folgt definiert sein:
...
`https://api.mercedes-benz.com/dealer/v1/dealers?latitude=48.7378333&longitude=9.2944224&fields=dealers(dealerId,address(street,city),communicationChannels(email))&apikey=<insert_your_api_key_here>`
> * Was ist passiert?
